...
<head>
    ...
    <link rel="icon" href="assets/images/dek.ico">
...
<header>
    <nav class="navbar">
        <div class="container-fluid">
            ...
            -->
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-bug-fill" viewBox="0 0 16 16" opacity="0.05">
    ...
    <div class="container">
        <div class="row">
            <div>
                ...
                <a id="dropdownMenuLink" class="btn align-self-center" href="#" style="float: right">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        if ($result->num_rows > 0) {
                            $counter = 1;
                            echo "Nalezeno " . '<strong>'.$result->num_rows .'</strong>'." záznamů";
